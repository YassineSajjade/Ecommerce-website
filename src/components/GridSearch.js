...
function GridSearch() {
    ...
    return (
        <>
            ...
            <div id="carouselExampleCaptions" className="row carousel " style={{ marginTop: "30px" }}>
                ...
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block slider3">
                            <div className="icon" style={{ marginBottom: "10px" }}><img src="//cdn.shopify.com/s/files/1/0108/7370/0415/files/slider-icon_100X.png?v=1581426760" /></div>
