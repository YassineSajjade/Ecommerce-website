...
function Footer() {
    return (
        <footer>
            {/* Begin Main-footer */}
            <div className="grid-uniformF" style={{marginBottom:"30px"}}>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-3 grid__item grid-oneQuarter">
                        ...
                        <div className="col-12 col-md-9 grid__item grid-threeQuarter" >
